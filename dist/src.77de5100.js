...
const getElement = id => {
  ...
  if (!el) throw new Error("Element not found: ".concat(id));
  return el;
};
let shapeTypeSelect;
let propertyGroups;
...
const chooseShape = shapeType => {
  Object.entries(propertyGroups).forEach(_ref => {
...
const calculateArea = shape => {
  switch (shape.type) {
    case "circle":
      return "Area of Circle: ".concat((Math.PI * shape.radius ** 2).toFixed(2));
    case "rectangle":
      return "Area of Rectangle: ".concat(shape.width * shape.height);
    case "triangle":
      return "Area of Triangle: ".concat(0.5 * shape.base * shape.height);
    default:
...
const initializeApp = () => {
  ...
  for (const _ref3 of Object.entries(propertyInputs)) {
...
},{}],"../../../home/codespace/.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../home/codespace/.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.ts"], null)
